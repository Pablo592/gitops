...
while IFS= read -r LINE; do
    ...
    if [ -n "$LINE" ]; then
        ...
        request="https://<chart-museum-domain>/api/charts/$chart_name/$chart_version"
        ...
        if [[ $response == *'{"error":'* ]]; then
            ...
            -u "$user:$pass" "https://<chart-museum-domain>/api/charts/$chart_name/$chart_version")
        ...
        -u "$user:$pass" https://<chart-museum-domain>/api/charts)
